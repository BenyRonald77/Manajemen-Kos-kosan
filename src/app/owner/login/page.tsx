...
export default function OwnerLoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-6 px-6">
      <div>
        <h1 className="text-2xl font-bold text-brand-700">Login Pemilik Kos</h1>
        <p className="mt-1 text-sm text-slate-500">Kelola kamar, penghuni, dan pendapatan.</p>
      </div>
      ...
      <p className="text-center text-xs text-slate-400">
        Demo: pemilik@kos.test / owner123
      </p>
    </main>
  );
}
